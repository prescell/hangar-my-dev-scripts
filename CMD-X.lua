...
CMDS.commands = {
	...
	["unnotifyfollowed"] = "()",
	["replicateanim"] = "Replicates animation id and plays it. (CREDIT: CURVN, RIPTXDE)",
...
function useCommand.replicateanim()
	...
	opx("-","Now replicating anim, creds to Curvn and Riptxde")
	local Char = cmdlp.Character
...
if not AntiCheat.PrintingOff then
	...
	StarterGui:SetCore("ChatMakeSystemMessage", {
		Text = "github.com/PrescionX '"..prefix.."'";
		Color = Color3.fromRGB(100, 100, 100);
		Font = Enum.Font.SourceSansBold;
		TextSize = 20
	})
