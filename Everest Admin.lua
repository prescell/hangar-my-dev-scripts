...
function GetPlayer(String) -- Created by PrescionX
    local Found = {}
...
adminversion = "Everest by PrescionX"
...
CMDBAR.Name = "CMDBAR"
CMDBAR.Parent = Frame
CMDBAR.BackgroundColor3 = Color3.new(14, 14, 0.207843)
CMDBAR.BackgroundTransparency = 0.80000000298023
CMDBAR.Size = UDim2.new(0, 240, 0, 20)
...
CMDBAR.Text = "Write cmd here or press ; "
...
lplayer.Chatted:Connect(function(msg)
    ...
    if string.sub(msg, 1, 8) == (prefix.."fecheck") then
        if game:GetService("Workspace").FilteringEnabled == true then
            ...
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Title = "Enjoy the Everest";
                Text = "Filter Wrap Successful! ";
            })
        else
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    ...
    Text = "Everest v1.18 is ready to use!";
})
wait(0.1)
print("Everest v1.18 is ready to use!")
if game:GetService("Workspace").FilteringEnabled == true then
    warn("FE is Enabled (Filtering Enabled)")
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Enyoj the Everest";
        Text = "Filter Wrap Successful!";
    })
else
    warn("FE is Disabled (Filtering Disabled) Consider using a different admin script.")
...
ImageLabel.Image = "http://www.roblox.com/asset/?id=4406750115"
